...
![Group Policy Management Editor showing password policy settings including enforce history 24, max age 60 days, min length 14 characters, complexity enabled](/assets/images/compliance-lab-11-gpo-password-policy.png)
...
![Group Policy Management Editor showing account lockout policy with 5 attempt threshold and 15 minute duration](/assets/images/compliance-lab-12-gpo-lockout-policy.png)
...
![Wazuh events view for DC01 showing Windows logon success and user logoff events](/assets/images/compliance-lab-13-wazuh-windows-events.png)
...
![Wazuh File Integrity Monitoring events for DC01 showing registry key modifications with syscheck event type and rule level 5](/assets/images/compliance-lab-14-wazuh-fim-alert.png)
...
![OpenSCAP CIS scan running on linux-endpoint showing pass and fail results scrolling in terminal](/assets/images/compliance-lab-09-openscap-report.png)
...
![OpenSCAP HTML compliance report showing 69.07% score, 165 passed 167 failed, evaluation target linux-endpoint with CIS profile](/assets/images/compliance-lab-10-openscap-report.png)
...
![Hydra brute force attack running from kali-attack targeting linux-endpoint SSH service with password attempts visible](/assets/images/compliance-lab-15-kali-brute-force.png)
...
![Wazuh events for linux-endpoint showing 799 hits with rule 2502 level 10 and rule 5760 SSH authentication failures from brute force attack](/assets/images/compliance-lab-16-wazuh-brute-force-alert.png)
...
![Wazuh NIST 800-53 compliance dashboard showing 16701 total alerts mapped to control requirements across all five agents](/assets/images/compliance-lab-17-wazuh-compliance-dashboard.png)
