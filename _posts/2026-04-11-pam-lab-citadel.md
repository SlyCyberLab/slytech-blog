---
layout: post
title: "Building a PAM Lab on Citadel: Tiered Admins, JIT Access, and Privilege Escalation Detection"
date: 2026-04-11
categories: [homelab, security, activedirectory]
tags: [pam, privileged-access, active-directory, powershell, jit, windows-server, identity]
---
...
![PAM lab architecture on Citadel](/assets/images/00-pam-lab-architecture.png)
...
## The gotcha: AdminCount and SDProp

Before building anything, check your existing privileged groups for `AdminCount = 1`. AD automatically sets this flag on members of protected groups like Domain Admins and Enterprise Admins. The SDProp process then overwrites the ACLs on those accounts every 60 minutes, which means any custom permissions you set on those accounts will get silently reverted.
...
Run this before you start. Know what's already flagged. It matters when you're designing your audit script later.
...
![Full OU tree showing Admin-Accounts with Tier0, Tier1, Tier2 and PAM groups OU](/assets/images/01-pam-ou-structure.png)
...
![ADUC showing tiered admin accounts in their respective OUs](/assets/images/02-pam-admin-accounts.png)

![Terminal output showing clean PAM group memberships](/assets/images/03-pam-group-members.png)
...
![GPO-PAM-Tier0-Restrictions showing deny policies applied to PAM-Tier0-Admins](/assets/images/04-pam-tier0-gpo.png)

![GPO-PAM-Tier1-Restrictions showing deny policies applied to PAM-Tier1-Admins](/assets/images/05-pam-tier1-gpo.png)

![GPO-PAM-Tier2-Restrictions showing deny policies applied to PAM-Tier2-Admins](/assets/images/06-pam-tier2-gpo.png)
...
![JIT elevation active, showing countdown to expiration](/assets/images/07-jit-elevation-active.png)

![JIT elevation revoked, green confirmation message](/assets/images/08-jit-elevation-revoked.png)
...
![Full JIT audit log output](/assets/images/09-jit-log.png)
...
![Privileged account audit terminal output showing table and summary](/assets/images/10-pam-audit-run.png)

![Audit CSV opened in Excel showing all privileged account entries](/assets/images/11-pam-audit-csv.png)
...
![ADUC showing both service accounts in the Service-Accounts OU](/assets/images/12-pam-service-accounts.png)

![Terminal showing svc.backup with no privileged groups and svc.legacy in Domain Admins](/assets/images/13-pam-service-account-comparison.png)
...
![Event ID 4728 showing mwebb added to Domain Admins](/assets/images/14-pam-escalation-event.png)
