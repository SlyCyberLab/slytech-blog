...
Parts 1 and 2 got data flowing and detections running. By the end of Part 2 I had a brute force alert firing every 5 minutes and a dashboard showing failed logon activity across the lab. But running detections and having a SOC workflow are two different things. Part 3 closes the loop.
...
![Splunk Security Essentials home page loaded successfully](/assets/images/splunk-p3-01-sse-home.png)
...
![T1110 search results in Security Essentials showing seven brute force detections](/assets/images/splunk-p3-02-sse-t1110-content.png)
...
![Basic Brute Force Detection detail showing ATT&CK tactic, technique, and threat groups](/assets/images/splunk-p3-03-sse-basic-brute-force.png)
...
![Live Data showing 0 events and a red warning about the src field](/assets/images/splunk-p3-04-sse-live-detection.png)
...
![Live Data showing 31,231 events with both prerequisites passing green](/assets/images/splunk-p3-05-sse-live-detection-fixed.png)
...
![Hydra running SSH brute force against 10.0.0.228 with 10 password attempts](/assets/images/splunk-p3-06-hydra-attack.png)
...
![Splunk showing 20 failed logon events from win11-002 including fakeuser accounts and admin](/assets/images/splunk-p3-07-splunk-catches-attack.png)
...
![Clone dialog showing Citadel - Brute Force Detection being created with Bookmarked status](/assets/images/splunk-p3-09-clone-detection.png)
