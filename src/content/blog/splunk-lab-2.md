...
date: 2026-03-24
description: "Building brute force detection with SPL, configuring scheduled alerts, and creating security dashboards in Splunk."
category: detection
tags:
  - splunk
  - spl
...
[Part 1](https://blog.slytech.us/blog/splunk-lab-1/) got Splunk running with Universal Forwarders on two Windows endpoints. Logs were flowing. But staring at a raw event stream isn't detection engineering, it's just data collection. Part 2 is where the actual work starts.
...
[Part 3](https://blog.slytech.us/blog/splunk-lab-3/) closes the loop by mapping these detections to MITRE ATT&CK using the Splunk Security Essentials app, cloning and customizing the detection for the Citadel lab, and tying the whole series together into a complete SOC workflow.
