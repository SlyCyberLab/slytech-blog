...
![Proxmox VM overview showing all lab VMs on Citadel](/images/compliance-lab-01-proxmox-vm-overview.png)
...
![pfSense firewall rules showing zone isolation between Management, Corporate, and Workstation networks](/images/compliance-lab-08-pfsense-zone-rules.png)
...
![Wazuh dashboard first login showing agents summary and compliance modules](/images/compliance-lab-02-wazuh-dashboard-first-login.png)
...
![Active Directory Users and Computers showing slytech.us domain with OU structure](/images/compliance-lab-04-dc01-ad-running.png)
...
![Wazuh agents list showing security-manager, DC01, and kali-attack all active](/images/compliance-lab-07-wazuh-all-agents-active.png)
...
![Kali terminal showing hostname kali-attack and static IP 10.10.30.10 confirmed](/images/compliance-lab-06-kali-first-login.png)
...
![Wazuh agents list confirming all three endpoints reporting in](/images/compliance-lab-03-wazuh-agents-active.png)
