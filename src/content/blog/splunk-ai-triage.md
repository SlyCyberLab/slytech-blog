...
date: 2026-03-25
description: "Building a Python tool that pulls Windows Security events from Splunk and uses the Anthropic API to generate structured SOC triage reports with MITRE ATT&CK mapping."
category: detection
tags:
  - splunk
  - python
