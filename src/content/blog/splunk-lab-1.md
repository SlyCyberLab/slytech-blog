...
This is Part 1 of a 3-part series. [Part 2](https://blog.slytech.us/splunk-lab-2/) covers SPL searches and correlation rules. Part 3 brings in MITRE ATT&CK mapping and a Splunk vs Wazuh comparison.
...
[Part 2](https://blog.slytech.us/splunk-lab-2/) covers SPL searches in depth, building correlation rules, and a dashboard that turns raw events into something readable. If you run into the same Kerberos vs NTLM issue I hit, Part 2 will cover how to search for both event types properly.
