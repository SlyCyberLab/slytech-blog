...
date: 2026-03-19
description: "Mapping a five-VM homelab to all six NIST CSF 2.0 functions with live attack simulation, automated response, and snapshot-based recovery."
category: compliance
tags:
  - nist
  - wazuh
...
The lab is still the same five-VM environment on Citadel. pfSense segmenting four zones, Wazuh collecting logs from four agents, dc01 running Active Directory, linux-endpoint as the OpenSCAP compliance target, and kali-attack as the threat simulation machine. If you're jumping in here, [Part 1](https://blog.slytech.us/compliance-lab-1/) covers the infrastructure and [Part 2](https://blog.slytech.us/compliance-lab-2/) covers the ISO 27001 work.
...
![Wazuh agents list showing all four active endpoints reporting to the SIEM](/images/compliance-lab-22-wazuh-agents-active.png)
...
![OpenSCAP HTML compliance report showing 78.12% score after targeted remediations on linux-endpoint](/images/compliance-lab-24-openscap-post-remediation.png)
...
![Wazuh Threat Hunting dashboard showing linux-endpoint agent with 1,012 hits and a clear spike at the time of the brute force attack](/images/compliance-lab-18-wazuh-detect-brute-force.png)
...
![Wazuh NIST 800-53 compliance dashboard showing 46,553 total alerts mapped to control requirements with spike visible on March 17](/images/compliance-lab-23-wazuh-nist-dashboard.png)
...
![Wazuh active-responses.log on linux-endpoint showing firewall-drop command executing with Kali's IP 10.10.30.10 as the target](/images/compliance-lab-19-wazuh-active-response.png)
...
![Hydra terminal showing all children disabled due to too many connection errors after Wazuh active response blocked the IP](/images/compliance-lab-20-hydra-blocked.png)
...
![Proxmox snapshot list for VM 216 showing pre-part3-remediation snapshot as the recovery point](/images/compliance-lab-21-proxmox-snapshots.png)
