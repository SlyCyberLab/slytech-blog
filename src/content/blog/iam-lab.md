...
date: 2026-04-09
description: "End-to-end IAM lab covering PowerShell provisioning and deprovisioning workflows, least-privilege OU structure, quarterly access review simulation, and GPO-based access control on Windows Server."
category: iam
tags:
  - iam
  - active-directory
...
![IAM lab architecture on Citadel](/images/00-lab-architecture.png)
...
![Full OU and group structure in ADUC](/images/01-ou-structure.png)
...
![ResourceGroups OU expanded](/images/02-resourcegroups.png)

![RoleGroups OU expanded](/images/03-rolegroups.png)
...
![Provisioning script running for all five test users](/images/04-provisioning-script-run.png)
...
![Full provisioning log output](/images/05-provisioning-log.png)
...
![Sales OU showing Webb, Cruz, Blake](/images/06-sales-users-ou.png)

![IT OU showing Holt, Novak](/images/07-it-users-ou.png)

![Marcus Webb group membership showing Sales-Users and FileShare-Sales-RW](/images/08-group-membership.png)
...
![Deprovisioning script terminal output](/images/09-deprovisioning-run.png)

![Deprovisioning log showing every step](/images/10-deprovisioning-log.png)
...
![Disabled OU showing jblake](/images/11-disabled-ou.png)

![jblake account properties showing offboarding description](/images/12-jblake-properties.png)
...
![Access review terminal output with stale flags](/images/13-access-review-run.png)

![Access review CSV opened in Excel](/images/14-access-review-csv.png)
...
![Sales GPO drive map showing S: to \\FS01\Sales](/images/16-sales-gpo-drivemap.png)

![Sales GPO HTML report showing Control Panel and CMD restrictions enabled](/images/17-sales-gpo-restrictions.png)
...
![IT GPO drive map showing I: to \\FS01\IT](/images/18-it-gpo-drivemap.png)

![GPMC showing both GPOs linked to their respective OUs](/images/19-gpo-links.png)
...
![NTFS ACLs on both shares](/images/15-share-permissions.png)
